...
// The server implementation of bacotell_common.Command.
...
// commandServer implements bacotellpb.CommandServer.
...
// The client implementation of bacotell_common.Command.
type commandClient struct {
	client bacotellpb.CommandClient
	broker *plugin.GRPCBroker
}

// commandClient implements bacotell_common.Command.
...
// The server implementation of bacotell_common.ExecuteProxy.
...
// executeProxyServer implements bacotellpb.InteractionProxyServer, bacotellpb.ExecuteProxyServer.
var (
...
// The client implementation of bacotell_common.ExecuteProxy.
...
// executeProxyClient implements bacotell_common.InteractionProxy, bacotell_common.ExecuteProxy.
var (
...
// The server implementation of bacotell_common.AutocompleteProxy.
...
// autocompleteProxyServer implements bacotellpb.AutocompleteProxyServer.
...
// The client implementation of bacotell_common.AutocompleteProxy.
type autocompleteProxyClient struct {
	client bacotellpb.AutocompleteProxyClient
}

// autocompleteProxyClient implements bacotell_common.AutocompleteProxy.
